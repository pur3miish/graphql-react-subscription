 ...
 * @property {string} GQL_CONNECTION_KEEP_ALIVE Hearbeat of the ws subscription. See {@link https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API/Writing_WebSocket_servers#Pings_and_Pongs_The_Heartbeat_of_WebSockets The HeartBeat of WebSockets}
 * @property {string} GQL_CONNECTION_TERMINATE Client request to terminate the WebSocket connection.
 * @property {string} GQL_START Client request to start listening to a GraphQL subscription opperation.
 * @property {string} GQL_DATA Server response with data.
 * @property {string} GQL_ERROR Server GraphQL Error response.
 * @property {string} GQL_COMPLETE Server response indicating GraphQL subscription opperation is complete.
 * @property {string} GQL_STOP Client request stop listening to a subscription opperation.
 */
